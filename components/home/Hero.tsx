    ...
    <section className="relative overflow-hidden bg-slate-50">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-14 px-5 pb-20 pt-18 sm:px-8 md:pt-24 lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:px-10 lg:pb-28">
        <div>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">ERPVers helps manufacturers extend Infor LN with practical web applications, mobile workflows, and integrations—built around the way your teams already work.</p>
          <ul className="mt-7 grid gap-3 sm:grid-cols-2 lg:grid-cols-1" aria-label="ERPVers capabilities">
